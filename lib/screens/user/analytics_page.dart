...
class AnalyticsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return UserDashboardScaffold(
      ...
      body: _AnalyticsDashboardBody(),
    );
  }
}

class _AnalyticsDashboardBody extends StatefulWidget {
  @override
  State<_AnalyticsDashboardBody> createState() =>
      _AnalyticsDashboardBodyState();
}

class _AnalyticsDashboardBodyState extends State<_AnalyticsDashboardBody> {
      ...
      child: loading
          ...
          : Column(
              ...
              children: [
                ...
                SizedBox(height: 12),
                // Pill-style tabs (horizontal scrollable row)
